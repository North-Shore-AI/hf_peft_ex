...
STATE_DIR="$PROJECT_ROOT/logs/peft-gap-impl"
LOG_DIR="$STATE_DIR/logs-$(date +%Y%m%d-%H%M%S)"
COMPLETED_FILE="$STATE_DIR/completed.txt"

# PEFT Gap Analysis Implementation Prompts
# Order: Core utilities first, then tuners by priority
PROMPTS=(
  "05_core_utilities_prompt.md"
  "01_ia3_prompt.md"
  "02_prompt_tuning_prompt.md"
  "03_prefix_tuning_prompt.md"
  "04_adalora_prompt.md"
)
...
echo "PEFT Elixir Port - Gap Implementation Runner"
echo "============================================="
...
echo "  1. Core Utilities (Mapping, Constants, Save/Load)"
echo "  2. IA3 (simplest tuner after LoRA)"
echo "  3. Prompt Tuning (prompt learning paradigm)"
echo "  4. Prefix Tuning (per-layer prefixes)"
echo "  5. AdaLoRA (adaptive rank allocation)"
echo ""
