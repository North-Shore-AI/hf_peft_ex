defmodule HfPeftEx.Tuners.Lora.Conv2d do
  @moduledoc """
  LoRA wrapper for 2D convolution layers.
  ...
  @type kernel_size :: {pos_integer(), pos_integer()}
  ...
  @type t :: %__MODULE__{
          ...
          stride: pos_integer() | {pos_integer(), pos_integer()},
          padding: :valid | :same | non_neg_integer() | {non_neg_integer(), non_neg_integer()},
          dilation: pos_integer() | {pos_integer(), pos_integer()},
          groups: pos_integer(),
          use_rslora: boolean(),
          use_dora: boolean(),
  ...
  @doc """
  Creates a new Conv2d LoRA layer.
  ...
  """
  @spec new(pos_integer(), pos_integer(), pos_integer() | kernel_size(), keyword()) :: t()
  def new(in_channels, out_channels, kernel_size, opts \\ []) do
    ...
    lora_a = init_lora_a(r, in_channels * k_h * k_w)
  ...
  defp normalize_kernel_size({k_h, k_w}), do: {k_h, k_w}
  defp normalize_kernel_size(k) when is_integer(k), do: {k, k}
  ...
  @doc """
  Computes the delta weight for Conv2d.
  """
  ...
  @doc """
  Forward pass through Conv2d with LoRA (and optional DoRA).
  """
